...
// Matches the validated data-viz palette: one hue, because a single series
// needs no colour encoding — bar length already carries the value.
const SERIES_COLOR = '#2a78d6'
const GRID_COLOR = '#e7ebf1'
            ...
            <div className="h-56">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={series} margin={{ top: 4, right: 8, bottom: 0, left: -20 }}>
                  ...
                  <XAxis
                    dataKey="date"
                    tickFormatter={(value) => formatDay(value, days)}
                  ...
                  <YAxis
                    ...
                    width={44}
                  />
                  <Tooltip cursor={{ fill: GRID_COLOR, fillOpacity: 0.5 }} content={<ChartTooltip />} />
                  {/* Rounded top corners, square at the baseline. */}
                  <Bar dataKey="evaluations" fill={SERIES_COLOR} radius={[4, 4, 0, 0]} maxBarSize={38} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </>
